...
const IntegrationCard = ({ title, icon, description, strategy }: Props) => {
  ...
  return (
    <div className="border-2 border-[#3352CC] rounded-2xl gap-x-5 p-5 flex items-center justify-betweem">
      {icon}
      ...
      <Button
        ...
        className="bg-gradient-to-br text-white rounded-full text-lg from-[#3352CC] font-medium
