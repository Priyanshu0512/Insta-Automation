...
export const ThenAction = ({ id }: Props) => {
  const {
    onSetListener,
    register,
    isPending,
      ...
      <div className="flex flex-col gap-y-2">
              ...
              <div
                ...
                className={cn(
                  Listener === listener.type
                    ...
                    : "bg-background-80",
                  "p-3 rounded-xl flex flex-col gap-y-2 cursor-pointer hover:opacity-80 transistion duration-100"
                )}
              >
        ...
        <form onSubmit={onFormSubmit} className="flex flex-col gap-y-2">
          <Textarea
            placeholder={
              Listener === "SMARTAI"
                ? "Add a prompt that your A.I. can use..."
