...
export const ThenNode = ({ id }: Props) => {
  ...
  return !data?.data?.listener ? (
    ...
    <div className="w-full lg:w-10/12 relative xl:w-6/12 p-5 rounded flex flex-col bg-[#1D1D1D] gap-y-3">
      <div className="absolute h-20 bottom-full left-1/2 flex flex-col items-center z-50 ">
